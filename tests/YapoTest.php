...
class YapoTest extends PHPUnit_Framework_TestCase {
    ...
    public function test_get() {
        ...
        $this->assertEquals($company_id_10->id, 10);
        $this->assertEquals($company_id_10->name, 'Apple');
        $this->assertEquals($company_id_10->description,
            'Apple Inc., formerly Apple Computer, Inc., is an American multinational corporation headquartered in Cupertino, California that designs, develops, and sells consumer electronics, computer software and personal computers.'
        );
        $this->assertEquals($company_id_10->ceo->name, 'Steve Jobs');
        $this->assertEquals($company_id_10->ceo->sex, '1');
        $this->assertEquals($company_id_10->ceo->sex->text(), 'Male');
        $this->assertEquals(
            array_map(function($e) {return $e->name;}, $company_id_10->employees->getArrayCopy()),
            array(0 => 'Steve Jobs', 1 => 'Steve Wozniak')
        );
        $this->assertEquals($company_id_10->brief, 'Apple, founded in 1976.');
        ...
        // // if
        // $employee_id_30 = Employee::get(30);
    }
